        ...
        <div className="container mx-auto px-4 py-3 flex justify-between items-center">
          ...
          <nav aria-label="Navegación principal" className="hidden md:flex items-center space-x-8">
            {NAV_ITEMS.map((item) => (
              ...
              >
                <button  aria-expanded={hoveredItem === item.title}
    aria-controls={`submenu-${item.title}`} className="flex items-center text-gray-700 dark:text-gray-200 hover:text-primary dark:hover:text-secondary transition-colors">
                  {item.title}
